...
$userInfo = '{"firstName": "Fayaz", "lastName": "Goulam", "language": "fr", "timeZone": "Europe/Paris", "email": "fayaz@social-computing.com", "login": "fgm", "password": "pwd", "connectionType": "local", "status": "active", "type": "external"}';

// Sign the request
$time = time();
$strParams = "oauth_timestamp=" . $time . "&oauth_token=" . SUPER_TOKEN . "&q=" . $userInfo;
$signature = sha1(CLIENT_ID . "&" . $strParams . "&" . CLIENT_SECRET);

$client = new Zend_Http_Client();
$client->resetParameters();
$client->setMethod("POST");
$client->setUri(BK_URL . '/api/v3/user');
...
$client->setParameterPost('q', $userInfo);
